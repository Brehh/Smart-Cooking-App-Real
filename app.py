...
with tabs[2]:
    ...
    <li style='font-size: 1.6rem; font-weight: bold; margin-top: 10px;'>1. นาย กัลปพฤกษ์ วิเชียรรัตน์ (คนแบกอิๆๆ😎) - ประธานเว็บไซต์</li>
    ...
    <li style='font-size: 1.6rem; font-weight: bold; margin-top: 10px;'>ราชาแห่งความมืด☠️ ภณพล ช่วยบุญส่ง (ผู้ให้กำลังใจ No.3) 👿</li>
